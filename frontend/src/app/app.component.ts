...
@Component({
  ...
  template: `
    <div *ngIf="ready; else loading" class="app-shell" [class.login-layout]="!auth.isAuthenticated || auth.mustChangePassword" [class.sidebar-compact]="compact" [class.drawer-open]="drawerOpen">
